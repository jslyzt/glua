...
.. image:: https://godoc.org/github.com/jslyzt/glua?status.svg
    :target: http://godoc.org/github.com/jslyzt/glua
...
There are some benchmarks on the `wiki page <https://github.com/jslyzt/glua/wiki/Benchmarks>`_ .
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc <http://godoc.org/github.com/jslyzt/glua>`_ for further information.

Note that elements that are not commented in `Go doc <http://godoc.org/github.com/jslyzt/glua>`_ equivalent to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ , except GopherLua uses objects instead of Lua stack indices.
...
Refer to `Lua Reference Manual <http://www.lua.org/manual/5.1/>`_ and `Go doc(LState methods) <http://godoc.org/github.com/jslyzt/glua>`_ for further information.
...
Refer to `Go doc(LState methods) <http://godoc.org/github.com/jslyzt/glua>`_ for further information.
...
.. code-block:: bash
   ...
   go get github.com/jslyzt/glua/cmd/glua
...
How to Contribute
----------------------------------------------------------------
See `Guidlines for contributors <https://github.com/jslyzt/glua/tree/master/.github/CONTRIBUTING.md>`_ .
